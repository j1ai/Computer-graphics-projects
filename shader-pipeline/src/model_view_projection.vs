...
void main()
{
  ...
  float PI = 3.1415927;
  vec4 input_position = vec4(pos_vs_in, 1.0);
  ...
  if (is_moon){
    ...
    pos_cs_in = proj * view * (moon_model * uniform_scale(0.3) * input_position + translate);
  }
  else{
    pos_cs_in = proj * view * moon_model * input_position;
  }
  /////////////////////////////////////////////////////////////////////////////
}
